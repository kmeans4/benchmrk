...
export function GridHeader({
  ...
  return (
    <div className="sticky top-0 z-30 flex overflow-hidden rounded-[22px] border border-white/8 bg-[#0b0b10]/92 shadow-[0_14px_32px_rgba(5,7,12,0.34)] backdrop-blur-xl">
      <div
        className="relative sticky left-0 z-40 flex min-h-[92px] items-center border-r border-white/10 bg-[#0b0c12]/96 px-5 py-4 shadow-[12px_0_28px_rgba(5,7,12,0.34)] backdrop-blur-xl"
      ...
      >
        <div>
          ...
          <p className="mt-1.5 text-sm font-semibold leading-5 text-white">Name · provider · footprint</p>
        </div>
      ...
      {benchmarks.map((benchmark, index) => {
        ...
        return (
          <motion.button
            ...
            className={cn(
              'group relative flex min-h-[92px] shrink-0 flex-col justify-between gap-3 border-r border-white/5 px-4 py-4 text-left transition-[background-color,box-shadow,transform] duration-200 hover:bg-white/[0.045] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_12px_24px_rgba(6,182,212,0.05)] active:scale-[0.99]',
          ...
          >
            <div className="space-y-3">
              <p className="text-[13px] font-semibold leading-5 text-white/92">
